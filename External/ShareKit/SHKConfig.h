...
#define SHKMyAppName			@"Roskilde app"
#define SHKMyAppURL				@"http://roskildeapp.com"
...
#define SHKFacebookKey				@"3926ed69d41f673a31aeb0c7fec2b1f8"
#define SHKFacebookSecret			@"ee01d5795b00a218314fea576899013d"
 ...
 */
#define SHKTwitterConsumerKey		@"oA2tOgZVG45GY7wCajZWw"
#define SHKTwitterSecret			@"4rOVO89x56YhZf4ukpmyLoPXak4KFwt9xMt8iSck"
#define SHKTwitterCallbackUrl		@"http://roskildeapp.com/twittercallback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"robocat" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
