//
//  NSManagedObjectContext+UpdateEntity.m
//  Podio
//
...
#import "NSManagedObjectContext+UpdateEntity.h"
...
- (void)updateEntity:(NSString *)entity
	  fromDictionary:(NSDictionary *)importDict
	  withIdentifier:(NSString *)identifier
		 overwriting:(NSArray *)overwritables
