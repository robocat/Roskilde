...
// Make changes to RFMusic2011.h instead.
...
@interface RFMusic2011ID : NSManagedObjectID {}
@end

@interface _RFMusic2011 : NSManagedObject {}
...
@interface _RFMusic2011 (CoreDataGeneratedAccessors)

@end

@interface _RFMusic2011 (CoreDataGeneratedPrimitiveAccessors)
